...
export default function ProjectCard() {
    return (
        <div className="w-[430px] h-[132px] flex gap-5 bg-[#0F0F10] p-3 rounded-[20px] border border-transparent hover:border-[#323234]">
            <div className="size-24 rounded-md overflow-hidden flex-shrink-0">
                <img src="/project1.jpg" alt="Projeto" className="w-full h-full object-cover" />
            </div>
            <div className="flex flex-col gap-2">
                <span className="uppercase text-xs font-bold tetxt-[#87BB2D]">10 Cliques</span>
